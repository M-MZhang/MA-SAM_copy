...
parser.add_argument('--output', type=str, default='/root/autodl-tmp/save/v6.7_Synapse_H_10_ngpu4')
...
parser.add_argument('--weight_decay', type=float, default=0.01, help='data loader threads')
