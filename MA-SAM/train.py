...
parser.add_argument('--output', type=str, default='/root/data1/zmm/seg4medicine/save/Vanille_me_v5.22')
...
parser.add_argument('--lr_exp', type=float, default=4, help='The learning rate decay expotential')
