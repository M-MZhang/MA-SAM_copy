...
parser.add_argument('--output', type=str, default='/root/data1/zmm/seg4medicine/save/Vanille_me_v6.5')
...
parser.add_argument('--warmup_period', type=int, default=300, help='Warp up iterations, only valid when warmup is activated')
