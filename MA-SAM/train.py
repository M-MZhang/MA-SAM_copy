...
parser.add_argument('--root_path', type=str, default='/root/autodl-tmp/isic2017', help='root dir for data')
parser.add_argument('--output', type=str, default='/root/autodl-tmp/save/v6.7_isic2017_B_2')
...
parser.add_argument('--stop_epoch', type=int, default=180, help='maximum epoch number to train')
