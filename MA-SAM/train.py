...
parser.add_argument('--root_path', type=str, default='/root/autodl-tmp/data/BTCV', help='root dir for data')
parser.add_argument('--output', type=str, default='/root/autodl-tmp/save/v6.7_BTCV_H_5')
parser.add_argument('--data_path', type=str, default='/root/autodl-tmp/data/BTCV')
