...
parser.add_argument('--output', type=str, default='/root/data1/zmm/seg4medicine/save/Vanille_me_v3')
...
parser.add_argument('--output', type=str, default='/root/autodl-tmp/save/Ft-SAM/UDIAT/test')
parser.add_argument('--visual_path', type=str, default='/root/autodl-tmp/visualization/Ft-SAM/UDIAT')
