...
parser.add_argument('--output', type=str, default='/root/autodl-tmp/save/v6.7_Synapse_H_10_224')
...
parser.add_argument('--batch_size', type=int, default=80, help='batch_size per gpu')
